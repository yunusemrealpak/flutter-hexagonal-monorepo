...
/// What delivery needs from the outside world, in the product's words.
///
...
/// technology throws and returns a [DeliveryFailure] instead.
abstract interface class DeliveryRepository {
  /// Loads the record stored under [id].
  Future<Result<String, DeliveryFailure>> byId(String id);
}
