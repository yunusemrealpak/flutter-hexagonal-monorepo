/// The wire shape of a delivery record.
///
...
final class DeliveryDto {
  /// Creates the DTO.
  const DeliveryDto({required this.id});
  ...
  factory DeliveryDto.fromJson(Map<String, Object?> json) =>
      DeliveryDto(id: json['id']! as String);
