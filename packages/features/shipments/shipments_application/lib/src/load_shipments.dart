...
/// One product intention: read a shipments record by its identifier.
///
...
final class LoadShipments
    implements UseCase<String, Result<String, ShipmentsFailure>> {
  ...
  const LoadShipments(this._repository);

  final ShipmentsRepository _repository;

  @override
  Future<Result<String, ShipmentsFailure>> call(String input) =>
