/// The wire shape of a payments record.
///
...
final class PaymentsDto {
  /// Creates the DTO.
  const PaymentsDto({required this.id});
  ...
  factory PaymentsDto.fromJson(Map<String, Object?> json) =>
      PaymentsDto(id: json['id']! as String);
