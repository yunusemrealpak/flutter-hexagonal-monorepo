...
/// One product intention: read a payments record by its identifier.
///
...
final class LoadPayments
    implements UseCase<String, Result<String, PaymentsFailure>> {
  ...
  const LoadPayments(this._repository);

  final PaymentsRepository _repository;

  @override
  Future<Result<String, PaymentsFailure>> call(String input) =>
