...
/// What routing needs from the outside world, in the product's words.
///
...
/// technology throws and returns a [RoutingFailure] instead.
abstract interface class RoutingRepository {
  /// Loads the record stored under [id].
  Future<Result<String, RoutingFailure>> byId(String id);
}
