...
/// One product intention: read a identity record by its identifier.
///
...
final class LoadIdentity
    implements UseCase<String, Result<String, IdentityFailure>> {
  ...
  @override
  Future<Result<String, IdentityFailure>> call(String input) =>
