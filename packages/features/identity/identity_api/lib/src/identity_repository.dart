...
/// What identity needs from the outside world, in the product's words.
///
...
/// technology throws and returns a [IdentityFailure] instead.
abstract interface class IdentityRepository {
  /// Loads the record stored under [id].
  Future<Result<String, IdentityFailure>> byId(String id);
}
