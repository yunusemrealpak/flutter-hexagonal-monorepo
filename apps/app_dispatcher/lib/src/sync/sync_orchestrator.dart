...
/// happens loses no work, and this app's queue is in memory anyway — a desk
/// that loses its network for a minute is not a van in a basement. It is here
/// because the policy is the same one and the alternative is a desk whose
/// reassignments sit unqueued until somebody notices the review screen.
