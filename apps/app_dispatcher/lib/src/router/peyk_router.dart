...
/// routers; the app collects them and builds one. `app_dispatcher` and
...
/// every app forever.
///
/// **The third copy of this file, deliberately.** An app may depend on
...
/// Three apps assembling route modules are three apps making the same decision
/// today, not one decision they share: the day this app grows a shell route
/// with a persistent sidebar beside the board, that change belongs here and
/// nowhere else.
///
/// Ninety lines each is the price. The alternative is a package three apps
/// negotiate over, and the negotiation is what makes a `common` package grow.
