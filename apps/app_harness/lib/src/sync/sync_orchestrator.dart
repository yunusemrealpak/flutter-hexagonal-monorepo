...
/// happens loses no work. This app composes every feature, so it composes this
/// too — and its `FakeNetworkStatus` is what makes the transition a test can
/// drive rather than a device it has to wait for.
